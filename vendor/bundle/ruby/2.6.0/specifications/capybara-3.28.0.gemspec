...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<regexp_parser>.freeze, ["~> 1.5".freeze])
  ...
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 0.72".freeze])
  ...
  s.add_development_dependency(%q<selenium-webdriver>.freeze, ["~> 3.5".freeze])
