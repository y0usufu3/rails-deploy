...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<hoe-mercurial>.freeze, ["~> 1.4".freeze])
  s.add_development_dependency(%q<hoe-deveiate>.freeze, ["~> 0.10".freeze])
  s.add_development_dependency(%q<hoe-highline>.freeze, ["~> 0.2".freeze])
  s.add_development_dependency(%q<rake-compiler>.freeze, ["~> 1.0".freeze])
  s.add_development_dependency(%q<rake-compiler-dock>.freeze, ["~> 0.7.0".freeze])
