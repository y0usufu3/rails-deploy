...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<actionpack>.freeze, [">= 5.0.1.x".freeze])
  s.add_runtime_dependency(%q<actionview>.freeze, [">= 5.0.1.x".freeze])
  s.add_runtime_dependency(%q<activesupport>.freeze, [">= 5.0.1.x".freeze])
  s.add_development_dependency(%q<railties>.freeze, ["> 5.0.1.x".freeze])
