...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<childprocess>.freeze, [">= 0.5".freeze, "< 3.0".freeze])
  s.add_runtime_dependency(%q<rubyzip>.freeze, ["~> 1.2".freeze, ">= 1.2.2".freeze])
  ...
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 0.67.0".freeze])
